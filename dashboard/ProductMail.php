<?php
    ...
    $query = "SELECT * FROM compras WHERE NoFactura = '12'";
    ...
    /* DETALLES COMPRA */
    $query1 = "SELECT * FROM detallescompra WHERE NoFactura = '$numberF' ORDER BY Categoria DESC";
...
try {
    ...
    $mail->Password   = '@Patitodehule.123';                               //SMTP password
