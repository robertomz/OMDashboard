...
<?php
    ...
    $query = "SELECT * FROM compras c INNER JOIN estadocompra ec ON c.IdEstado = ec.IdEstado ORDER BY Fecha DESC";
...
<div class="container">
    <h1><i class='fa fa-shopping-basket'></i> Compras Realizadas </h1>
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="tableCompras" class="table table-striped table-bordered table-condensed" style="width:100%">
                        <thead>
                            <tr>
                                <th> Estado </th>
                                <th> Fecha/Hora </th>
